...
[pars.EPOCH_ONSETS,pars.EPOCH_OFFSETS,pars.EPOCH_NAMES,...
   pars.DS_BIN_DURATION,pars.R] = ...
   defs.Experiment('EPOCH_ONSETS','EPOCH_OFFSETS','EPOCH_NAMES',...
      'DS_BIN_DURATION','LVR_R');
