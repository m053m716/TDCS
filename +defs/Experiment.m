...
pars.TREATMENT_FILE_KEY = ...
   {'0_0mA-Anodal','0_0mA-Cathodal','0_2mA-Anodal',...
   '0_2mA-Cathodal','0_4mA-Anodal','0_4mA-Cathodal'};
pars.TREATMENT_FILE_KEY_MAT = ...
   [pars.TREATMENT_FILE_KEY(1:2:5); ...
    pars.TREATMENT_FILE_KEY(2:2:6)]';
pars.NAME_KEY = ...
   {'0.0 mA Anodal','0.0 mA Cathodal','0.2 mA Anodal',....
   '0.2 mA Cathodal','0.4 mA Anodal','0.4 mA Cathodal'};
pars.NAME_KEY_MAT = ...
   [pars.NAME_KEY(1:2:5); ...
    pars.NAME_KEY(2:2:6)]';
...
pars.CONDITION_CUR_COL = mat2cell(pars.CONDITION_COL,ones(1,size(pars.CONDITION_COL,1)),3);
pars.CONDITION_CUR_COL = [pars.CONDITION_CUR_COL(1:2:end), pars.CONDITION_CUR_COL(2:2:end)];
pars.EPOCH_COL_FACTOR = [0.5, 1.0, 0.75];
