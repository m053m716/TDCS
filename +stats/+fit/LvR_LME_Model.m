function [lme,lmetbl,A,C,D] = LvR_LME_Model(S)
...
%
%  -- Output --
%  lme : Matlab `LinearMixedModel` object for running statistical
%        analysis of LvR distributions observed during Pre, Stim, and Post
%        epochs of the tDCS experiments.
%
%  [lmetbl,A,C,D] : See documentation for `ranova()` Matlab function
