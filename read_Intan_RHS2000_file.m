function read_Intan_RHS2000_file(fname,suppressAmp,stimFile)
%READ_INTAN_RHS2000_FILE  Read binary file with tDCS data streams
%
%  >> read_Intan_RHS2000_file;
%  >> read_Intan_RHS2000_file(fname);
%  >> read_Intan_RHS2000_file(fname,suppressAmp);
...
if nargin < 1
   ...
   if isempty(e)
      e = '.rhs';
   elseif ~strcmpi(e,'.rhs')
      error(['tDCS:' mfilename ':BadFileType'],...
         ['\n\t->\t<strong>[TDCS.READ_INTAN_RHS2000_FILE]:</strong> ' ...
