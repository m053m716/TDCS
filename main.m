...
genSpikeRatePanelFigure(T,'TAG','_nRepeat8-vs-SHAM_ttest2',...
   'SIG_REPEATED',8,'H0',[],'SIG_TEST',@ttest2,'ALPHA',0.01);
genSpikeRatePanelFigure(T,'TAG','_nRepeat3-vs-SHAM_ttest2',...
   'SIG_REPEATED',3,'H0',[],'SIG_TEST',@ttest2,'ALPHA',0.01);
genSpikeRatePanelFigure(T,'TAG','_nRepeat4-vs-SHAM_WilcoxonRankSum',...
   'SIG_REPEATED',4,'H0',[],'SIG_TEST',@ranksumtest,'ALPHA',0.001);
genSpikeRatePanelFigure(T,'TAG','_nRepeat8-vs-SHAM_WilcoxonRankSum',...
   'SIG_REPEATED',8,'H0',[],'SIG_TEST',@ranksumtest,'ALPHA',0.01);
genSpikeRatePanelFigure(T,'TAG','_nRepeat8-vs-ZEROS_ttest2',...
   'SIG_REPEATED',8,'H0',0,'SIG_TEST',@ttest2,'ALPHA',0.01);
genSpikeRatePanelFigure(T,'TAG','_nRepeat3-vs-ZEROS_ttest2',...
   'SIG_REPEATED',3,'H0',0,'SIG_TEST',@ttest2,'ALPHA',0.01);
genSpikeRatePanelFigure(T,'TAG','_nRepeat3-vs-ZEROS_WilcoxonSignRank',...
   'SIG_REPEATED',3,'H0',0,'SIG_TEST',@signranktest,'ALPHA',0.01);
genSpikeRatePanelFigure(T,'TAG','_nRepeat8-vs-ZEROS_WilcoxonSignRank',...
   'SIG_REPEATED',8,'H0',0,'SIG_TEST',@signranktest,'ALPHA',0.01);
