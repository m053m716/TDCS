...
% genSpikeRatePanelFigure(data.delta_spikes,...
%    'EPOCH_NAMES',{'Pre','Stim','Post (full)'},...
%    'EPOCH_OFFSETS',[15 35 80],... % For convenience; one recording only went to 84 minutes
%    'SIG_SHOW_PROBABILITY',true,...
%    'XMINORTICK',[5 15 20 35 40 80],...
%    'XLIM',[3 83],...
%    'AGGREGATE_SHAM',true,...
%    'TAG','_Full-Duration-Delta-Rates');
